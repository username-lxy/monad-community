        ...
        >
          ...
          <div :class="`shadow ${moveIndex == i ? 'select_box' : ''}`">
            <div class="small_logo">
              <a
                :href="item.twitter || '#'"
                :target="item.twitter ? '_blank' : null"
                :class="{ a_hover: item.twitter }"
              ...
              >
                ...
                >
                  <path
                    ...
                    p-id="15216"
                    :fill="item.twitter != '' ? '#ffffff' : '#929090'"
                  ></path>
                </svg>
              </a>
              <a
                :href="item.discord_url || '#'"
                :target="item.discord_url ? '_blank' : null"
                :class="{ a_hover: item.discord_url }"
                @click="!item.discord_url && $event.preventDefault()"
              >
                <svg
                  t="1742672913599"
                  class="icon"
                ...
                >
                  <path
                    ...
                    :fill="item.discord_url != '' ? '#ffffff' : '#929090'"
                    p-id="10461"
                  ></path>
                </svg>
              </a>
              <a
                :href="item.magiceden_url || '#'"
                :target="item.magiceden_url ? '_blank' : null"
                :class="{ a_hover: item.magiceden_url }"
                @click="!item.magiceden_url && $event.preventDefault()"
              >
                <svg
                  t="1742673303151"
                  class="icon"
                ...
                >
                  <path
                    ...
                    p-id="17133"
                    :fill="item.magiceden_url != '' ? '#ffffff' : '#929090'"
                  ></path>
                </svg>
              </a>
            </div>
...
.wrap {
  ...
  .mascot_box {
    ...
    .mascot_2 {
      ...
      height: 800px;
      width: 100%;
      background-color: #a45ff2; /* 背景色 */
      clip-path: polygon(0% 0%, 100% 0%, 100% 100%, 0% 85%); /* 梯形裁剪 */
      z-index: 2;
      .nft {
        position: absolute;
        top: 0;
    ...
    .mascot_3 {
      ...
      height: 800px;
      width: 100%;
      background-color: #7fa6b7; /* 背景色 */
      clip-path: polygon(0% 0%, 100% 0%, 100% 90%, 0% 100%); /* 梯形裁剪 */
      z-index: 1;
